...
Specifically, for the 9 combinations fleet segment-metier,5 different models among the ones reported in Deiverable 2.2 ([Bitetto et al., 2023 – SEAwise Report on Carbon footprint, economic and social impacts of management strategies](https://data.dtu.dk/articles/online_resource/SEAwise_report_on_Carbon_footprint_economic_and_social_impacts_of_management_strategies/25012085)
...
Model 2 assumes that price as a function of the ratio between current landings and landings of the previous year, modified with respect to [Salz et al., 2011 – FISHRENT; Bio-economic simulation and optimisation model](https://research.wur.nl/en/publications/fishrent-bio-economic-simulation-and-optimisation-model):
...
tab1= read.table("C:\\Users\\Bitetto Isabella\\OneDrive - Coispa Tecnologia & Ricerca S.C.A.R.L\\H2020-SEAwise\\_____________WP2\\MOOCs_task 2.2\\output_fishprice\\all_fittings.csv",sep=";",header=TRUE)
...
tab2= read.table("C:\\Users\\Bitetto Isabella\\OneDrive - Coispa Tecnologia & Ricerca S.C.A.R.L\\H2020-SEAwise\\_____________WP2\\MOOCs_task 2.2\\output_fishprice\\Price_fittings.csv",sep=";",header=TRUE)
...
tab3= read.table("C:\\Users\\Bitetto Isabella\\OneDrive - Coispa Tecnologia & Ricerca S.C.A.R.L\\H2020-SEAwise\\_____________WP2\\MOOCs_task 2.2\\output_fishprice\\mod_selected.csv",sep=";",header=TRUE)
...
tab1= read.table("C:\\Users\\Bitetto Isabella\\OneDrive - Coispa Tecnologia & Ricerca S.C.A.R.L\\H2020-SEAwise\\_____________WP2\\MOOCs_task 2.2\\FuelCosts\\EnCost_model1.csv",sep=";",header=TRUE)
...
For more equations, refer to Deliverable 2.2  ([Bitetto et al., 2023 – SEAwise Report on Carbon footprint, economic and social impacts of management strategies](https://data.dtu.dk/articles/online_resource/SEAwise_report_on_Carbon_footprint_economic_and_social_impacts_of_management_strategies/25012085)
).
...
<div class="title">💡 Tips for model selection</div>
<ul>
...
<li><strong>Balance statistical and interpretative criteria</strong>: the best model is both statistically sound and economically plausible.</li>
